...
const invalidApiDocumentArrayLevelSelfLink = {
  "openapi": "3.1.0",
  "info": {
      ...
      "User": {
        ...
        "properties": {
          ...
          "links": {
            "type": "object",
            "properties": {
              // Removing the `self` member to generate a failing scenario for rule `fetching-data-fetching-resources-array-level-self-link`
              "fail": {
                "type": "string",
                "format": "uri"
              }
...
export default invalidApiDocumentArrayLevelSelfLink;
