...
const invalidApiDocumentSingleRelationshipLevelRelatedLink = {
  "openapi": "3.1.0",
  "info": {
    ...
    "schemas": {
      ...
      "RelationshipLinks": {
        ...
        "properties": {
          ...
          // Removing to generate a failing scenario for rule `fetching-data-fetching-resources-single-relationship-level-related-link`
          // "related": {
          //   "type": "string",
          //   "format": "uri"
          // }
...
export default invalidApiDocumentSingleRelationshipLevelRelatedLink;
