...
const invalidApiDocumentArrayIdType = {
  "openapi": "3.1.0",
  "info": {
  ...
  "components": {
    "schemas": {
      "User": {
        ...
        "properties": {
          "id": {
            // Changing the `id` member type to generate a failing scenario for rule `document-structure-resource-array-identification-id-type`
            "type": "fail",
...
export default invalidApiDocumentArrayIdType;
