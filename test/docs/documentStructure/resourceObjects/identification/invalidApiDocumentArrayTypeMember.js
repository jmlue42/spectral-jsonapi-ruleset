...
const invalidApiDocumentArrayTypeMember = {
  "openapi": "3.1.0",
  "info": {
    ...
    "schemas": {
      "User": {
        ...
        "properties": {
          ...
          // Removing `type` member to generate a failing scenario for rule `document-structure-resource-array-identification-type-member`
          // "type": {
          //   "type": "string",
...
export default invalidApiDocumentArrayTypeMember;
