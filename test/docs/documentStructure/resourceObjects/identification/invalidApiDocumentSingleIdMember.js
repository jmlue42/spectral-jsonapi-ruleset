...
const invalidApiDocumentSingleIdMember = {
  "openapi": "3.1.0",
  "info": {
  ...
  "components": {
    "schemas": {
      "User": {
        ...
        "properties": {
          // Removing the `id` member to generate a failing scenario for rule `document-structure-resource-single-identification-id-member`
          // "id": {
          //   "type": "string",
      ...
      "UserUpdateRequest": {
        ...
        "properties": {
          "data": {
            ...
            "properties": {
              // Removing `id` member to generate a failing scenario for rule `document-structure-resource-single-identification-id-member`
              // "id": {
              //   "type": "string"
              // },
              "type": {
...
export default invalidApiDocumentSingleIdMember;
