...
const invalidApiDocumentSingleTypeType = {
  "openapi": "3.1.0",
  "info": {
    ...
    "schemas": {
      "User": {
        ...
        "properties": {
          ...
          "type": {
            // changing `type` member type from 'string' to 'fail to generate a failing scenario for rule `document-structure-resource-single-identification-type-type`
            "type": "fail",
...
export default invalidApiDocumentSingleTypeType;
