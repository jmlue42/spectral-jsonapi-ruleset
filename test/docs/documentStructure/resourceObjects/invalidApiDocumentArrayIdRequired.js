...
const invalidApiDocumentArrayIdRequired = {
  "openapi": "3.1.0",
  "info": {
  ...
  "components": {
    "schemas": {
      "User": {
        ...
        "properties": {
          // Creating a failing scenario where `id` member is required. removing will cause the rule to fail
          // "id": {
          //   "type": "string",
...
export default invalidApiDocumentArrayIdRequired;
