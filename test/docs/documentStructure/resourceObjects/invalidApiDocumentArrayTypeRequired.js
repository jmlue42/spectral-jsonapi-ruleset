...
const invalidApiDocumentArrayTypeRequired = {
  "openapi": "3.1.0",
  "info": {
    ...
    "schemas": {
      "User": {
        ...
        "properties": {
          ...
          // Creating a failing scenario where `type` member is required. removing will cause the rule to fail
          // "type": {
          //   "type": "string",
...
export default invalidApiDocumentArrayTypeRequired;
