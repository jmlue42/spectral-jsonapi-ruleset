...
const invalidApiDocumentArrayAttributesType = {
  "openapi": "3.1.0",
  "info": {
  ...
  "components": {
    "schemas": {
      ...
      "UserAttributes": {
        // Changing `attributes` type to generate a failing scenario - original: "object"
        "type": "fail",
        "required": [
          "name",
          "email"
...
export default invalidApiDocumentArrayAttributesType;
