...
const invalidApiDocumentSingleNoLinksMember = {
  "openapi": "3.1.0",
  "info": {
    ...
    "schemas": {
      ...
      "AttributesObject": {
        ...
        "properties": {
          ...
          // Adding this `links` member to generate a failing scenario
          "links": {
            "type": "object"
          },
          "email": {
...
export default invalidApiDocumentSingleNoLinksMember;
