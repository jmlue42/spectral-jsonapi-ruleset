...
const invalidApiDocumentSingleNoRelationshipsMember = {
  "openapi": "3.1.0",
  "info": {
    ...
    "schemas": {
      ...
      "AttributesObject": {
        ...
        "properties": {
          ...
          // Adding this `relationships` member to generate a failing scenario
          "relationships": {
            "type": "object"
          },
          "email": {
...
export default invalidApiDocumentSingleNoRelationshipsMember;
