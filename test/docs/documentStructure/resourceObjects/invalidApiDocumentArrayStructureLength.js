...
const invalidApiDocumentArrayStructureLength = {
  "openapi": "3.1.0",
  "info": {
    ...
    "schemas": {
      "User": {
        ...
        "properties": {
          ...
          // Creating a failing scenario that exceeds to maximum amount of members allowed for a `Resource Object`
          "fiveMember": {
            "type": "string"
          },
          "sixMember": {
...
export default invalidApiDocumentArrayStructureLength;
